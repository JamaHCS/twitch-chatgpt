  ...
  .get('/gpt/:text', async (req, res) => {
    ...
    if (response.data.choices) {
      ...
      if (agent_response.length > 399) {
        console.log(
          'Agent answer exceeds twitch chat limit. Slicing to first 399 characters.'
        );
